...
function sendMail($to,$title,$content){
    ...
    $mail->Username ='cproblemofficial';//smtp登录的账号 这里填入字符串格式的qq号即可
    $mail->Password = '404page';//smtp登录的密码 使用生成的授权码（就刚才叫你保存的最新的授权码）【非常重要：在网页上登陆邮箱后在设置中去获取此授权码】
    $mail->From = 'cproblemofficial@126.com';//设置发件人邮箱地址 这里填入上述提到的“发件人邮箱”
